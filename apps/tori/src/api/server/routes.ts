...
import connectionRoute from "@/api/modules/platform/integration/connection/route.ts";
import integrationRoute from "@/api/modules/platform/integration/proxy-instance/route.ts";
import notifyRoute from "@/api/modules/platform/notification/notification/route.ts";
import subscriptionRoute from "@/api/modules/platform/notification/subscription/route.ts";
