...
export const bindingGrants = pgTable("binding_grant", {
  id: text("id")
    .primaryKey()
    .$defaultFn(() => uniqueId()),
...
export const claimSessions = pgTable("claim_session", {
  id: text("id")
    .primaryKey()
    .$defaultFn(() => uniqueId()),
...
export const compensationCases = pgTable("compensation_case", {
  id: text("id")
    .primaryKey()
    .$defaultFn(() => uniqueId()),
